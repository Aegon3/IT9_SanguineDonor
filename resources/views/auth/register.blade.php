...
.role-opt{
    flex:1;padding:9px 14px;background:var(--bg);border:1px solid var(--border2);
...
.btn-register{
    ...
    font-family:'Inter',sans-serif;cursor:pointer;transition:background .15s;margin-top:4px;
}
...
<div class="split">
    ...
    <div class="panel">
        ...
        <form method="POST" action="{{ route('register.post') }}">
            ...
            <div class="form-group">
                <label>Email Address <span style="color:var(--muted2)">(optional)</span></label>
            ...
            <div class="role-options">
                ...
                <label style="flex:1">
                    ...
                    <div class="role-opt {{ old('role','donor') === $val ? 'selected':'' }}">{{ $label }}</div>
                </label>
                @endforeach
            </div>
