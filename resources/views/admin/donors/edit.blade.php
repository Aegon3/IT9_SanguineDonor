@extends('layouts.app')
@section('title', 'Edit Donor — SanguineDonor')
...
@section('content')
<div class="page-title">Edit Donor</div>
<div class="page-sub">Update donor profile — {{ $donor->full_name }}</div>
...
<form method="POST" action="{{ route('admin.donors.update', $donor->id) }}">
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <select name="blood_type" required>
                    ...
                    <option value="{{ $bt }}" {{ old('blood_type', $donor->blood_type) === $bt ? 'selected':'' }}>{{ $bt }}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
                ...
                <select name="status" required>
                    ...
                    <option value="{{ $s }}" {{ old('status', $donor->status) === $s ? 'selected':'' }}>{{ $s }}</option>
                    @endforeach
                </select>
            </div>
        </div>
    ...
    <div class="form-actions">
        <button type="submit" class="btn btn-red">Update Donor</button>
